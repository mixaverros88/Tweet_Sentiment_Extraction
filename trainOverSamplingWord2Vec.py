...
X = convert_data_frame_sentece_to_vector_array(word2vec_model, train_data_frame_over_sampling)
...
# MLP Classifier
neural_network = MLPClassifierModel(X_train, X_test, y_train, y_test, config.get('MODELS', 'oversampling.word2vec.mlp'),
                                    'sss')
