...
from utils.serializedModels import tfidf_logistic_regression_over_sampling, tfidf_svm_over_sampling, \
    tfidf_decision_tree_over_sampling, tfidf_k_neighbors_over_sampling, tfidf_nb_over_sampling, \
...
# Vectorized - BOW
tfidf_of_words_over_sampling = Tfidf(corpus)
vectors_bag_of_words_over_sampling = tfidf_of_words_over_sampling.text_vectorization_test_data_set_over_sampling()

X = vectors_bag_of_words_over_sampling
y = test_data_set['sentiment']

# Logistic Regression
lg = tfidf_logistic_regression_over_sampling()
print("Logistic Regression")
print(classification_report(y, lg.predict(X)))

# Support Vector Machine
svm = tfidf_svm_over_sampling()
print("Support Vector Machine")
print(classification_report(y, svm.predict(X)))

# Gaussian Naive Bayes
gn = tfidf_nb_over_sampling()
print("Gaussian Naive Bayes")
print(classification_report(y, gn.predict(X)))

# MLP Classifier
mpl = tfidf_multi_layer_perceptron_classifier_over_sampling()
print("MLP Classifier")
print(classification_report(y, mpl.predict(X)))

# Decision Tree
dt = tfidf_decision_tree_over_sampling()
print("Decision Tree")
print(classification_report(y, dt.predict(X)))

# KNeighbors
kn = tfidf_k_neighbors_over_sampling()
print("KNeighbors")
