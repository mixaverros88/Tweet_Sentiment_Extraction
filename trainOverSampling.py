...
train_target_values_over_sampling = get_column_values_as_np_array(target_column, train_data_frame_over_sampling)
test_target_values = get_column_values_as_np_array(target_column, test_data_frame)

# target_values = np.concatenate((train_target_values_over_sampling, test_target_values))

# Tokenize data frame
train_corpus_over_sampling = tokenize_sentence(train_data_frame_over_sampling)
test_corpus = tokenize_sentence(test_data_frame)

# corpus = train_corpus_over_sampling + test_corpus

# Vectorized - BOW
bag_of_words_over_sampling = BoW(train_corpus_over_sampling, 'bag_of_words_over_sampling')
...
X_train, X_test, y_train, y_test = train_test_split(vectors_bag_of_words_over_sampling,
                                                    train_target_values_over_sampling, test_size=0.3, random_state=32)
