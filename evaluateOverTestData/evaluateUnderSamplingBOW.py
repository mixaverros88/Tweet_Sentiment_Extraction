...
vectors_bag_of_words_under_sampling = bag_of_words_under_sampling.text_vectorization_test_data_set_under_sampling()

X = vectors_bag_of_words_under_sampling
y = test_data_set['sentiment']

# Logistic Regression
lg = bag_of_words_logistic_regression_under_sampling()
print("Logistic Regression")
print(classification_report(y, lg.predict(X)))

# Support Vector Machine
svm = bag_of_words_svm_under_sampling()
print("Support Vector Machine")
print(classification_report(y, svm.predict(X)))

# Gaussian Naive Bayes
gn = bag_of_words_nb_under_sampling()
print("Gaussian Naive Bayes")
print(classification_report(y, gn.predict(X)))

# MLP Classifier
mpl = bag_of_words_multi_layer_perceptron_classifier_under_sampling()
print("MLP Classifier")
print(classification_report(y, mpl.predict(X)))

# Decision Tree
dt = bag_of_words_decision_tree_under_sampling()
print("Decision Tree")
print(classification_report(y, dt.predict(X)))

# KNeighbors
kn = bag_of_words_k_neighbors_under_sampling()
print("KNeighbors")
